      ...
      case when p1.id in (select x.viagem id 
       ...
       group by z.viagem)x 
          where x.contagem <> 1) 
                ...
                p7.n_femeas n_femeas_tot,
                p7.n_nao_observados n_nao_observados_tot,
                p7.n_nao_determinados n_nao_determinados_tot,                                       p7.peso_machos_amostr,
                p7.peso_femeas_amostr,
                p7.peso_nao_observados_amostr,
                p9.classe_comp,
                p9.n_machos,
                p9.n_femeas,
                p9.n_nao_observados,
                p9.n_nao_determinados,
                p9.peso_machos,
                p9.peso_femeas,
                p9.peso_nao_observados,
                p9.peso_nao_determinados
           from pnab.viagem p1,
                pnab.venda p2,
                pnab.embarcacao emb,
                pnab.porto por,
...
select distinct p1.id id_viagem,
      ...
      case when rpo.desig = 'Norte' then 'NW' 
           when rpo.desig = 'Centro' then 'SW' else 
                ...
                p7.n_femeas n_femeas_tot,
                p7.n_nao_observados n_nao_observados_tot,
                p7.n_nao_determinados n_nao_determinados_tot,
                p7.peso_machos_amostr,
                p7.peso_femeas_amostr,
                p7.peso_nao_observados_amostr,
                p9.classe_comp,
